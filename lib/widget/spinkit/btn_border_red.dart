...
/// </pre>
///
class BorderRedButton extends StatelessWidget {
  final _name;
  final double width;
  final double height;
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
        decoration: BoxDecoration(
          ...
          border:  Border.all(color: ResColors.red_e2, width: 1.0),
